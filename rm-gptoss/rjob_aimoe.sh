...
export KUBEBRAIN_NAMESPACE="ailab-aimoe"
...
rjob submit --name=rm-gptoss-8002 \
  --gpu=2 --memory=400000 --cpu=32 \
  --charged-group=aimoe_gpu \
  --private-machine=group \
  --mount=gpfs://gpfs1/p1-shared:/mnt/shared-storage-user/p1-shared \
  --image=registry.h.pjlab.org.cn/ailab-p1-p1_gpu/slime:20250909-v1 \
  --positive-tags node/gpu-l-lg-cmc-h-h200-0365.host.h.pjlab.org.cn \
  -P 1 --host-network=true \
  -e DISTRIBUTED_JOB=true \
  -e NCCL_PXN_DISABLE=0 \
  -- bash /mnt/shared-storage-user/p1-shared/chenjiacheng/p1-slime/rm-gptoss/run_rm.sh -m 34882 -r 8002