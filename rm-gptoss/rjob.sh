...
rjob submit --name=rm-gptoss-8005 \
  ...
  --positive-tags node/gpu-lg-cmc-h-h200-2509.host.h.pjlab.org.cn \
  -P 1 --host-network=true \
  -e DISTRIBUTED_JOB=true \
  -e NCCL_PXN_DISABLE=0 \
  -- bash /mnt/shared-storage-user/p1-shared/chenjiacheng/p1-slime/rm-gptoss/run_rm.sh -m 34886 -r 8005