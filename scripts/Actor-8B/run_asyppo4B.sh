...
CKPT_ARGS=(
   ...
   --ref-load /mnt/shared-storage-user/p1-shared/liyizhuo/share/models/Qwen3-8B-Base-torch_dist
   --load /mnt/shared-storage-user/p1-shared/Qwen/Qwen3-8B-Base
   --save /mnt/shared-storage-user/p1-shared/liyizhuo/share/save/AsyPPO/4B/Actor_8B
   ...
   --critic-load /mnt/shared-storage-user/p1-shared/Qwen/Qwen3-4B-Base
   --critic-save /mnt/shared-storage-user/p1-shared/liyizhuo/share/save/AsyPPO/4B/Critic_4B
